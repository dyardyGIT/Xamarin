...
namespace dr2
{
    [Activity(Label = "dr2", MainLauncher = true, Icon = "@drawable/icon")]
    public class MainActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            drawerToggle = new Android.Support.V7.App.ActionBarDrawerToggle(this, drawerLayout, Resource.String.DrawerOpenDescription, Resource.String.DrawerCloseDescription);
            ...
            // Disable the ActionBar Activity icon on pre-Lollipop devices
